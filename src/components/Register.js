...
const Register = () => {
    ...
    return (
        <div className='from-inherit' style={{display: "flex", backgroundImage: `url("https://img5.goodfon.com/wallpaper/nbig/5/f9/tsvet-forma-fon-208.jpg") `, height: "800px"}}>
            <Form style={{ display: "inline-block", border: "1px solid transparent", margin: "60px auto", padding: "30px"}}>
                ...
                <Form.Group className="mb-3" controlId="formBasicPassword">
                    ...
                    <Form.Text id="passwordHelpBlock" muted>
                        Your password must be 8-20 characters long with atleast one uppercase, one special character and one digit.
                    </Form.Text>
                </Form.Group>
                ...
                <br/> <br/>
                 < h3 > Alredy a user <Link to='/login' > <Button className='btn btn-danger'> Login here</Button> </Link></h3>
            </Form>
        </div>
    );
};
