          ...
          <div className='details-main'>
            <div className='details-poster'>
              ...
              <div className='details-heading'>
                ...
                <Button variant='outline-primary' className='fav-btn' onClick={(e) => addToFav(e)} style={{ marginRight: "20px" }}>Add to Favorite</Button>
                <Button variant='outline-danger' className='fav-btn' onClick={(e) => removeFav(e)} >Remove from Favorite</Button>
                <Button variant='outline-primary' className='fav-btn' onClick={(e) => addToPublic(e)} style={{ marginRight: "20px" }}>Add to Public</Button>
                <Button variant='outline-danger' className='fav-btn' onClick={(e) => removePublic(e)} >Remove from Public</Button>
              </div>
            </div>
